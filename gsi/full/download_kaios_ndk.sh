...
cd ~/.mozbuild
wget https://github.com/b2g-gsi/build-actions/releases/download/ndk-macos/android-ndk-0-darwin-x86_64.tar.bz2 
tar -zxvf ./android-ndk-0-darwin-x86_64.tar.bz2 
